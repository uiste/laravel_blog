...
@section('content')
	...
	<div class="menu_box">
		<ul>
			...
			<li>
            	<h3><i class="fa fa-fw fa-th-large"></i>分类管理</h3>
                <ul class="sub_menu">
            ...
            <li>
                ...
                <ul class="sub_menu">
                    <li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-paperclip"></i>友情链接</a></li>
                    <li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-support"></i>导航管理</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2016. Powered By <a href="http://www.uiste.com">http://www.uiste.com</a>.
	</div>
	<!--底部 结束-->
@endsection